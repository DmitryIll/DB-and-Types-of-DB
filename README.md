...
4. Начинаем транзакцию (вообще возможны варианты, предполагаю возможне такой вариант)

- Банк формирует операцию, например, типа в электронном журнале, что с такого-то счета будет списаны средства на перевод на другой счет (возможно даже в другом банке) 
- В таблице в которой указывается баланс средств исходного счета вычесть указаннаю сумму.
- в таблице, которая соответствует счету получателя - прибавить сумму.
- возможно в каких-то дополнительных таблицах пометить что операция проведена в такое-то время и дату. и т.п.
...
5. Результаты отправить пользователю CMC.
